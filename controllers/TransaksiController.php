...
use app\models\TransaksiStockSearch;
...
class TransaksiController extends Controller
{
    ...
    public function actionIndexstok()
    {    
        $searchModel = new TransaksiStockSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('indexstok', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Transaksi",
                    'content'=>'<span class="text-success">Create Transaksi success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
