 ...
 */
class TransaksiStockSearch extends Transaksi
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        ->select('id_barang,SUM(trans_masuk) AS jml_masuk,SUM(trans_keluar) AS jml_keluar,(SUM(trans_masuk) - SUM(trans_keluar)) AS stok_akhir')
        ->groupBy('id_barang');
